// in this example the bad thing is 
...
try
{
removeStudent(rollNumber); return Protocol.SUCCESS+Protocol.SEPARATOR+"Student deleted";
}catch(DAOException daoException)
{
return "EXCEPTION"+Protocol.SEPARATOR+daoException.getMessage();
}
...
responseData+=studentDTOInterface.getGender();
i++;
if(i<sz) responseData+=Protocol.SEPARATOR;
}
return responseData;
}catch(DAOException daoException)
{
...
{
System.out.println("Add student got called");
...
{
StudentDAOInterface studentDAOInterface;
studentDAOInterface=new StudentDAO(); return studentDAOInterface.getByRollNumber(rollNumber);
}
